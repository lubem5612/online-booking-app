...
<head>
    ...
    <meta property="og:title" content="Online Booking Warning Email">
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <div class="bodyContentArea" style="color: #455065; margin: 0px 20px;padding-bottom: 30px;text-align: center;">
                                                        <p style="font-size: 14px"><span>Hello</span> <span style="font-weight: bold;">{{$data['user']}}</span></p>
                                                        <br>
                                                        <p style="font-size: 14px">The following book will be expected to be checked in:</p>
                                                        <br>

                                                        <p style="font-weight: bold; text-align: left; margin-left: 35%"><span style="color: #3DB166;">Name -</span> <span style="color: #242424;">{{$data['title']}}</span></p>
                                                        <br>
                                                        <p style="font-weight: bold; text-align: left; margin-left: 35%"><span style="color: #3DB166;">Email -</span> <span style="color: #242424;">{{$data['date']}}</span></p>
                                                        <br>
